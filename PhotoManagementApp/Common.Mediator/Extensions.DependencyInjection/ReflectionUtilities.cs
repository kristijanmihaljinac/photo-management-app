...
namespace Common.Mediator.Extensions.DependencyInjection
{
    public static class ReflectionUtilities
    {
        public static void AddSimpleMediatorClasses(IServiceCollection services, IEnumerable<Assembly> assembliesToScan)
        {
            ...
            var openCommandQueryUseCaseInterfaces = new[]
            {
            ...
            AddInterfacesAsTransient(openCommandQueryUseCaseInterfaces, services, assembliesToScan, false);
